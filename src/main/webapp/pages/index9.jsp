...
<div id="wrapper">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                ...
                                <div class="col2">收到DNS请求最多的Ip</div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/babel">
        ...
        return (
          <div className="row">
              <div className="text_div">
                  ...
                  <div id="spec_link">
                      <h3 id="spec_link"><a href={props.target_url} target="blank_window">{props.third_title}</a></h3>
                  </div>
              </div>
          </div>
        );
          ...
          $('#'+div_id).highcharts({
            ...
            yAxis: {
              ...
              title: {
                ...
                text: (tmp_max/1000).toString().substring(0,3)+'千次请求'
              },
              plotBands: [{
                from: 0,
                to: 60,
          ...
          $('#'+div_id).highcharts({
              ...
              yAxis: {
                ...
                title: {
                  ...
                  text: (tmp_max/10000).toString().substring(0,4)+'万次请求'
                },
                plotBands: [{
                  from: 0,
                  to: 90,
      ...
      var main_title=["HTTP请求次数最多的IP","Nat量排名","收到DNS请求最多的IP","NetFlow流量排名","网页访问次数排名","Syslog警报占比"]
      var sub_title=["HTTP请求次数最多的IP","Nat转换次数最多的IP","收到DNS请求最多的IP","NetFlow流量最大的IP","物理接口裸流量大小","Syslog最高级别的警报","正在访问外网的内网IP数"]
      var third_title=["IP地址：","IP地址:","IP地址:","IP地址:","流量大小:","最高级别的警告:","内网IP个数:"]
            ...
            if (!chart.renderer.forExport) {
              setInterval(function () {
                ...
                $.ajax({url:"./sqlRequest.do",success:function(result){
                  ...
                  document.getElementById("through_put1").innerHTML = result_set[0]+'Gbps';
                  document.getElementById("through_put2").innerHTML = result_set[1]+'Gbps';
                }})
              }, 5000);
            }
          });
