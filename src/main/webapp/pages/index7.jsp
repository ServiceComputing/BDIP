...
<body>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge col1" id = "http_tips">202.121.223.161</div>
                                    <div class="col2"> 发起Http请求最多的Ip</div>
                                </div>
                            </div>
                        </div>
                        <a href="#" id="http_tips_url" target="_blank">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge col1" id = "dns_tips">202.171.23.80</div>
                                    <div class="col2">收到DNS回复最多的Ip</div>
                                </div>
                            </div>
                        </div>
                        <a href="#" id="dns_tips_url" target="_blank">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge col1" id="syslog_tips">Critical</div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge col1">DNS Attack</div>
                                    <div class="col2">最近检测到的网络攻击</div>
                                </div>
                            </div>
                        </div>
                        <a href="/polls/pages/DNS.html" target="_blank">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-4">
                    <div class="col-md-4 switch-right" id="custom_border">
                        <div class="switch-right-grid">
                            <div class="switch-right-grid1" id="text1">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="col-md-12 notification_panel">
                            <div class="thumbnail">
                                <div class="caption-full">
                                    <h3><a href="/polls/pages/DNS.html">DNS 放大攻击</a></h3>
                                    <p>放大攻击（也称为杠杆攻击，英文名DNS Amplification Attack），利用回复包比请求包大的特点（放大流量），伪造请求包的源IP地址，将应答包引向被攻击的目标。对于DNS服务器来说，只需要抛弃不是自己发出去的请求包的应答包即可。</p>
                                    <br/>
                                    <h4><p>DNS服务器的ip为   202.121.64.5</p></h4>
                                    <br/>
                                    <h4>被攻击的ip地址   64.234.238.202</h4>
                                </div>
                             </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="list-group" id="alarm_try">
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
    ...
    <script type="text/babel">
        ...
        var column_handle = function paint_column(div_id,result,on_off){
            var my_data = string_parse(result);
            var tmp_max = my_data[0];
            var extent = tmp_max.toString().length-2;
            var tmp_max = tmp_max / Math.pow(10,extent);
            $(function () {
                $('#'+div_id).highcharts({
                    chart: {
                        type: 'gauge',
                    ...
                    series: [{
                        name: '吞吐量',
                        data: [Math.round(tmp_max)],
                        tooltip: {
                            valueSuffix: '* 10^'+extent.toString()+' bits'
                        }
                    }]
                });
            });
        ...
        var nat_handle = function paint_pie(div_id,result){
            ...
            $(function () {
                $('#'+div_id).highcharts({
                    ...
                    series: [{
                        name: '内网IP所占比例',
                        data: [Math.round((my_data[0]-my_data[1])/my_data[0]*100)],
                        tooltip: {
                            valueSuffix: ' %'
                        }
                    }]
        ...
        var dns_handle = function paint_pie(div_id,result) {
            ...
            var extent = max.toString().length-2;
            var tmp_max = max / Math.pow(10,extent);
            $(function () {
                $('#'+div_id).highcharts({
                    chart: {
                        type: 'gauge',
        ...
        function paint_picture(text_part,dns_part,type,extra_cmd,handle_type) {
            ...
            $.ajax({url:"http://127.0.0.1:8000/polls/pages/hbase/"+type,success:function(result){
                ...
                if (extra_cmd == 1){
                    $('#http_tips_url').attr('href',url_alt);
                    $('#http_tips').html(tmp2[2]);
                }else if (extra_cmd == 2){
                    $('#dns_tips_url').attr('href',url_alt);
                    $('#dns_tips').html(tmp2[2]);
                }else if (extra_cmd == 3){
                    $('#syslog_tips_url').attr('href',url_alt);
                    $('#syslog_tips').html(tmp2[2]);
                }
                ReactDOM.render(
                  <Clock
